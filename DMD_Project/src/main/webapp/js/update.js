...
var authorsCount = document.querySelector("meta[name = 'authorsCount']").getAttribute("content");
var affilsCount = document.querySelector("meta[name ='affilsCount']").getAttribute("content");
var loginsCount = document.querySelector("meta[name = 'loginsCount']").getAttribute("content");
